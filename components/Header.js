            ...
            <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto">
                ...
                <div className="flex items-center justify-end space-x-4">
                    ...
                    <div className="relative navBtn">
                        ...
                        <div className="absolute -top-1 -right-2 text-xs w-5 h-5 bg-red-500 rounded-full flex item-center justify-center animate-pulse text-white">3</div>
                    </div>
                    <PlusCircleIcon className="navBtn"/>
                    <UserGroupIcon className="navBtn"/>
                    <HeartIcon className="navBtn"/>
                    
                    <img src="https://i1.sndcdn.com/avatars-000191864169-xzno4r-t240x240.jpg" alt="proile pic" className="h-10 rounded-full cursor-pointer" />
                </div>
            </div>
        </div>
    )
